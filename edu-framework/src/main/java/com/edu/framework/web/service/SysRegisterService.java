...
import com.edu.common.core.domain.model.RegisterBody;
import com.edu.common.core.redis.RedisCache;
import com.edu.common.exception.user.CaptchaException;
import com.edu.common.exception.user.CaptchaExpireException;
...
public class SysRegisterService
{
    ...
    public String register(RegisterBody registerBody)
    {
        ...
        else
        {
            ...
            {
                AsyncManager.me().execute(AsyncFactory.recordLogininfor("1","2",username, Constants.REGISTER,
