...
import com.edu.common.enums.UserStatus;
...
public class UserDetailsServiceImpl implements UserDetailsService
{
    ...
    {
        return new LoginUser(user.getUserId(), user.getDeptId(),user.getCompanyId(), user, permissionService.getMenuPermission(user));
    }
}
